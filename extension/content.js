    ...
    root.innerHTML = `
      <section class="lineoa-shell" aria-live="polite">
        <header class="lineoa-header">
          <div><strong>LINEOA</strong><small>聊天室監控 v0.1.9</small></div>
          <nav aria-label="顯示模式">
    ...
    return `
      <section class="lineoa-admin-shell" aria-live="polite">
        <aside class="lineoa-admin-sidebar">
          <div class="lineoa-admin-brand"><span>LO</span><div><strong>LINEOA</strong><small>管理中心 v0.1.9</small></div></div>
          <nav>
